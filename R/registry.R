...
register_extra_blocks <- function() {
  blockr.core::register_blocks(
    ...
    description = c(
      ...
      "Transform data with a plain R script (no wrapper function). Assignments at the TOP of the script become controls: a factor renders a dropdown over its levels, a number a spin box, TRUE/FALSE a checkbox. A name starting with a dot stays private. Exports as idiomatic R with the current values written in.",
